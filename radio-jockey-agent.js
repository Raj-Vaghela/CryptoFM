/**
 * RADIOO - Radio Jockey Script Generator
 * 
...
async function generateScriptSegment(report, previousScript) {
  ...
  try {
    ...
    if (isNewBroadcast) {
      prompt = `
      You are a professional cryptocurrency radio news reporter and DJ for RADIOO, a cryptocurrency radio broadcast service. 
      ...
      For cryptocurrency terms that might be mispronounced by text-to-speech systems, use SSML to clarify pronunciation. For example, use <phoneme alphabet="ipa" ph="ˈɛks ɑr pi">XRP</phoneme> for XRP.
      
      Start with a brief introduction, including the station name (RADIOO), your name (choose an appropriate DJ name), and the current time (e.g., "It's ${getCurrentTimePhrase()}"). Then, include a disclaimer that this is an AI-generated broadcast and the information should not be considered financial advice. Then, proceed to the market updates from the report.
      ...
      REMINDER: The script should ONLY contain spoken words, with SSML tags where necessary for pronunciation. NO audio directions, sound effects, or anything in brackets.
      `;
    } else {
      prompt = `
      You are a professional cryptocurrency radio news reporter and DJ for RADIOO, a cryptocurrency radio broadcast service.
      ...
      ${includeDisclaimer ? "In this segment, include a short reminder that this is an AI-generated broadcast. Make it brief and natural, like 'By the way, this is your AI DJ here with the latest crypto news.' or 'As an AI-powered station, we're analyzing the data in real-time.'" : ""}
      ...
      REMINDER: The script must contain ONLY the actual spoken words with SSML tags where necessary for pronunciation. NO audio directions, sound effects, or anything in brackets.
      `;
    }
    ...
    // Remove any potential non-spoken elements
...
╔═══════════════════════════════════════════════════════════════╗
║                                                               ║
║             🎙️ RADIOO JOCKEY SCRIPT GENERATOR 🎙️             ║
║                                                               ║
╚═══════════════════════════════════════════════════════════════╝
